...
/**
 * Set NEXTAUTH_SECRET/SESSION_SECRET in a single .env file, preserving the existing quote style.
 * @param {string} envPath absolute path to the .env file
 * @param {string} secret the new NEXTAUTH_SECRET/SESSION_SECRET value
 */
